...
class Game{
    ...
    constructor(public difficulty: any){
        ...
        for(var i = 0; i < this.numberOfCard; i++){
          ...
          var test = createCard(difficulty.frtColor,color , i , difficulty.dif);
          var temp = new Card(i, false, color, test);//creation of a card
...
function play(event:any){
  ...
  return console.log("erreur play cardPlayed.length offerflow");
}
